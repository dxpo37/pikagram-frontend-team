import {databaseInputFieldChecker, inputFieldChecker, changeColors, placeholderMovement} from "./utils.js"
...
const firstnamePlaceholder = document.querySelector(".signupBox__firstnamePlaceholder")
const lastnamePlaceholder = document.querySelector(".signupBox__lastnamePlaceholder")
const usernamePlaceholder = document.querySelector(".signupBox__usernamePlaceholder")
const passwordPlaceholder = document.querySelector(".signupBox__passwordPlaceholder")

const emailStatusImage = document.querySelector(".signupBox__emailStatusImage")
const firstnameStatusImage = document.querySelector(".signupBox__firstnameStatusImage")
const lastnameStatusImage = document.querySelector(".signupBox__lastnameStatusImage")
const usernameStatusImage = document.querySelector(".signupBox__usernameStatusImage")
const passwordStatusImage = document.querySelector(".signupBox__passwordStatusImage")
...
window.addEventListener("load", ()=> { emailElement.value = "" ;  firstnameElement.value = "" ; lastnameElement.value = "" ; usernameElement.value = "" ;  passwordElement.value = "" })
...
passwordElement.addEventListener("keyup", (e)=>{
  ...
  if(passwordLength>5 && 
    ...
    emailStatusImage.classList.contains("available")) signupButton.removeAttribute('disabled')
  else  signupButton.setAttribute('disabled', true)

  if(passwordLength>=1&&passwordLength<5) changeColors(passwordStatusImage, passwordText, "tooshort", "grey", "too short" )
  else if(passwordLength>=5) {
    passwordStatusImage.classList.remove("tooshort")
    changeColors(passwordStatusImage, passwordText, "available", "green", "acceptable" ) 
  }
})
...
signupButton.addEventListener('click', async ()=>{
  const res = await fetch(`https://cryptic-river-74579.herokuapp.com/api/users/`, {
    method:"POST", 
